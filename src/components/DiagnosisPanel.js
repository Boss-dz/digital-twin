...
//   const [xaiImage, setXaiImage] = useState(null); // Holds the Grad-CAM image
...
//       // UPDATED: Use the object payload format shown in your API docs screenshot
//       const aiResponse = await client.predict("/predict", {
//         image: file,
//       });

//       // UPDATED: Dynamically find which output is the label and which is the image
...
//       // 2. Process Grad-CAM Image
//       // Gradio images usually return an object with a url or path
//       if (heatmapData) {
