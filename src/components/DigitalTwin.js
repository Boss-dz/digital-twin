...
// // Import the new icons for the camera controls
// import { AlertTriangle, Home, Box, Grid, ZoomIn, ZoomOut } from "lucide-react";

// // Updated CameraRig handles both alert focus and manual UI controls
...
//   // 1. Handles clicking a specific alert from the sidebar
//   useEffect(() => {
//     if (focusPos) {
...
//       // Shut off automation once we arrive so the user can use the mouse again
...
// // Custom UI Button Component for the Toolbar
